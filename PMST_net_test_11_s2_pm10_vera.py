...
# ==========================================
# 0. Global config: VERA-inspired S2 experiment
# ==========================================
TARGET_WINDOW_SIZE = 12
BASE_PATH = "/public/home/putianshu/vis_mlp"
# Keep Stage 1 and Stage 2 on the matching VERA feature layout.
S1_DIR = f"/public/home/putianshu/vis_mlp/ml_dataset_pmst_v5_aligned_{TARGET_WINDOW_SIZE}h_pm10_pm25_vera"
S2_DIR = f"/public/home/putianshu/vis_mlp/ml_dataset_s2_tianji_12h_pm10_pm25_monthtail_2_vera"

CONFIG = {
    # ========== 实验控制 ==========
    # 建议：S1 训练完成后将 S1_BEST_CKPT_PATH 指向对应 best_score.pt（勿重复定义 EXPERIMENT_ID）
    'EXPERIMENT_ID':           os.environ.get('S1_EXPERIMENT_ID', 'exp_vera'),
    'S2_RUN_SUFFIX':           os.environ.get('S2_RUN_SUFFIX', 'vera_s2'),
    'BASE_PATH':              BASE_PATH,
    ...
    # ========== Stage 1 VERA checkpoint ==========
    # Set S1_BEST_CKPT_PATH explicitly, or use checkpoints/{S1_EXPERIMENT_ID}_S1_best_score.pt.
     'S1_BEST_CKPT_PATH': os.environ.get('S1_BEST_CKPT_PATH'),
    ...
    # Per-step dynamic vars: load_data / resolve will override this from X_train.
    'DYN_VARS_COUNT':          27,
    # FE = 32 legacy fog proxies + 16 VERA-style intermediates + 4 time encodings.
    # load_data() will re-infer and override this from X_train.npy.
    'FE_EXTRA_DIMS':          52,
    'GRAD_CLIP_NORM':         0.5,
    'REG_LOSS_ALPHA':         0.1,
    'VAL_SPLIT_RATIO':        0.1,
...
def load_data(data_dir, scaler=None, rank=0, local_rank=0, device=None,
    ...
    scaler_path = os.path.join(
        ...
        f'robust_scaler_w{win_size}_dyn{dyn_vars_count}_s2_vera.pkl'
    )
