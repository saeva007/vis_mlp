...
- If a normal `git push origin main` fails with GitHub HTTPS reset, timeout, or `Could not connect to server`, retry with the method that worked in this workspace:
