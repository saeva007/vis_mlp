        ...
        if step % val_interval == 0:
            ...
            if rank == 0:
                ...
                if met['f2_score'] > best_f2:
                    ...
                    save_name = f"pmst_{stage_name.lower()}_best_f2_v3.pth"
                ...
                if met['ts_score'] > best_ts:
                    ...
                    save_name = f"pmst_{stage_name.lower()}_best_ts_v3.pth"
                    save_path = os.path.join(CONFIG['BASE_PATH'], f"model/{save_name}")
                    torch.save(model.module.state_dict() if world_size > 1 else model.state_dict(), save_path)
...
def main():
    ...
    if global_rank == 0:
        joblib.dump(scaler_s1, os.path.join(base_path, "scalers/scaler_pmst_balanced_v3.pkl"))
